...
| P14 | —       | Typed presentation delegated to `gamut_core::convert` (issue #268): lossless by default, `TiffDecoder::convert_policy` opts into alpha dropping and luma reduction | ✅ done |
