...
- **M2** — Pixel formats: 10/12-bit, 4:2:0/4:2:2, monochrome, profiles 0 & 2, `MA1B` baseline
  ...
  issue #335 — they need no plane-geometry change. 4:2:0, profile 0 and `MA1B` landed with #390;
  what remains is 10/12-bit, monochrome, and 4:2:2's coding path — #391.)*
...
**Deferred (planned, additive).** Every ☐ row below: pixel formats (10/12-bit, monochrome, and
4:2:2's coding path); alpha and depth auxiliary items; ICC / Exif / XMP; HDR
...
| seq_profile=0 (Main) / =2 (Professional, 12-bit/4:2:2) | Annex A §10.2 | ✅ (0 = 4:2:0; 2 signalled for 4:2:2, whose coding path is #391) | M2 |
