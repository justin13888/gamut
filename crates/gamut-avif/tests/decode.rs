...
fn unsupported_colour_falls_back_to_planar_only() {
    // YCgCo (matrix 8, a different construction) and BT.2020 constant-luminance (matrix 10, which
    // the RGBA surface does not model): planar decodes; RGBA is Unsupported.
